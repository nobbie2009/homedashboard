...
import { ClipboardList, Lock, Unlock, Settings as SettingsIcon, Calendar, LayoutDashboard, ClipboardCheck, Home, RefreshCw, WifiOff, Trophy, Sun, Moon, Clock, Music, Disc3, Droplets, Wrench, Plane } from 'lucide-react';
